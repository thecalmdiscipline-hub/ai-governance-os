...
router = APIRouter(prefix="/workflows/sales_lead_qualification", tags=["workflows"])

@router.post("/run", response_model=WorkflowRunResponse)
def run_sales_lead_qualification(
    ...
    result = run_workflow("sales_lead_qualification", req.input, dry_run=req.dry_run)
    return result
