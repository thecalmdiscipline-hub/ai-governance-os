...
router = APIRouter(prefix="/workflows/document_knowledge", tags=["workflows"])

@router.post("/run", response_model=WorkflowRunResponse)
def run_document_knowledge(
    ...
    result = run_workflow("document_knowledge", req.input, dry_run=req.dry_run)
    return result
