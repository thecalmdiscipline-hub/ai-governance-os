...
router = APIRouter(prefix="/workflows/quote_contract_generator", tags=["workflows"])

@router.post("/run", response_model=WorkflowRunResponse)
def run_quote_contract_generator(
    ...
    result = run_workflow("quote_contract_generator", req.input, dry_run=req.dry_run)
    return result
