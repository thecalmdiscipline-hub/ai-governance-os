...
router = APIRouter(prefix="/meeting-agenda-assistant", tags=["Workflows"])
...
def run(
    ...
    result = run_workflow_stub("meeting_agenda_assistant", {"input": body.input, "context": body.context, "user": current_user.username})
    return result
