...
router = APIRouter(prefix="/workflows/meeting_agenda_assistant", tags=["workflows"])

@router.post("/run", response_model=WorkflowRunResponse)
def run_meeting_agenda_assistant(
    ...
    result = run_workflow("meeting_agenda_assistant", req.input, dry_run=req.dry_run)
    return result
